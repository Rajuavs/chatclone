...
import '../screens/mobile_chat_screens.dart';
          ...
          children: [
            StreamBuilder<List<Group>>(
                ...
                builder: (context, snapshot) {
                  print("contactlist group ${snapshot.data}");
            ...
            StreamBuilder<List<ChatContact>>(
                ...
                builder: (context, snapshot) {
                  print("contactlist chatContacts ${snapshot.data}");
                  // List<ChatContact> abc = snapshot.data ?? [];

                  // abc.forEach((ele) {
                  //   print("${ele.contactId} , ${ele.timeSent}");
                  // });
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return const Loader();
                  }
